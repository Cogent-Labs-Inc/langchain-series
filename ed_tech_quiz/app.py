...
response_json= {
    "1": {"no":"1", "mcq" :"multiple choice question", "options":{"a": "choice here", "b": "choice here", "c": "choice here", "d": "choice here"}, "correct": "correct answer" },
    "2": {"no":"2", "mcq" :"multiple choice question", "options":{"a": "choice here", "b": "choice here", "c": "choice here", "d": "choice here"}, "correct": "correct answer" },
    "3": {"no":"3", "mcq" :"multiple choice question", "options":{"a": "choice here", "b": "choice here", "c": "choice here", "d": "choice here"}, "correct": "correct answer" }
}
template = """
Text: {text}
...
Make sure to format your response like the json format defined below and use it as a guide. Ensure to make the {number} MCQs.
{response_json}
"""
prompt_template = PromptTemplate(input_variables=["text", "number", "grade", "tone", "response_json"], template=template)
...
prompt_template = PromptTemplate(input_variables=["grade", "quiz"], template=template)
